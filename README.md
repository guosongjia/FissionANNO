...
- `intra_genus_HGT_from_<sp>` — likely acquired by horizontal transfer from a congeneric species (donor hit identity > 90% and exceeds the SOG-derived pairwise cutoff between reference and donor species members)
